...
import com.notaryapp.ui.activities.verifyauthenticate.EditProfileWitnessActivity;
...
public class LADEditProfileActivity extends BaseActivity {
...
//    private Integer idSigner,position;
   // private List<SignerReg> signerList;
    ...
    private List<LADParties> witnessList;
    private String done = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lad_activity_edit_profile);
        ...
        init();
        context = LADEditProfileActivity.this;
        ...
        if(extras == null) {
            ...
            try {
                ...
                /*if(!userTypeForm.equalsIgnoreCase("")) {
                    ...
                    }else if(userTypeForm.equalsIgnoreCase("WIT")){
        ...
        layOutWitnessOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LADEditProfileActivity.this, EditProfileWitnessActivity.class);
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LADEditProfileActivity.this.onBackPressed();
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data != null) {
            if (requestCode == PICK_IMAGE) {
                ...
                try {
                    bitmap = MediaStore.Images.Media.getBitmap(LADEditProfileActivity.this.getContentResolver(), selectedImageUri);
...
//            Log.e("SAVE_IMAGE", e.getMessage(), e);
        ...
        Uri imgUri = FileProvider.getUriForFile(LADEditProfileActivity.this,
