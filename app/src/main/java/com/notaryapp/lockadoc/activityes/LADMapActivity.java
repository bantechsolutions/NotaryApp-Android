...
public class LADMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(LADMapActivity.this);
        ...
        btnFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Geocoder geocoder = new Geocoder(LADMapActivity.this, Locale.getDefault());
                try {
                    ...
                    Log.d("MAP_STREET", streetName);
                    String cityName = addresses.get(0).getLocality();
                    Log.d("MAP_CITY", cityName);
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(LADMapActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(LADMapActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(LADMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION},
                    1000);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(LADMapActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            SettingsClient settingsClient = LocationServices.getSettingsClient(LADMapActivity.this);
            Task<LocationSettingsResponse> task = settingsClient.checkLocationSettings(builder.build());

            task.addOnSuccessListener(LADMapActivity.this, new OnSuccessListener<LocationSettingsResponse>() {
                @Override
            ...
            task.addOnFailureListener(LADMapActivity.this, new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    if (e instanceof ResolvableApiException) {
                        ResolvableApiException resolvable = (ResolvableApiException) e;
                        try {
                            resolvable.startResolutionForResult(LADMapActivity.this, 51);
...
//                            Toast.makeText(MapActivity.this, "unable to get location", Toast.LENGTH_SHORT).show();
    ...
    class SaveLocation extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void v) {
            super.onPostExecute(v);
            Intent locationIntent = new Intent(getApplicationContext(), LADAddLocationActivity.class);
