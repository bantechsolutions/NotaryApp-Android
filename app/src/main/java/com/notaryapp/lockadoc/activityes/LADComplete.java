...
public class LADComplete extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lad_activity_ca_complete);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*Intent intent = new Intent(LADComplete.this, DashBoardActivity.class);
...
//                                        phone = witness_obj.getString("phone");
                            ...
                            if (success.equals("1") ||
                                    data.getString("Completed").equalsIgnoreCase("already marked as completed") ) {
                                //   updateTransactions();
                                new DeleteAll().execute();
                                // Edited
                                /*Intent intent = new Intent(LADComplete.this, DashBoardActivity.class);
        ...
        ivInfoAlert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CustomDialog.notaryappInfoDialogAlert(LADComplete.this, getResources().getString(R.string.alert_test));
            }
        });
    }
...
//            HashMap<String, String> params = new HashMap<>();
    ...
    class DeleteAll extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String email) {
            ...
            Intent intent = new Intent(LADComplete.this, notaryappShareAppActivity.class);
            //Intent intent = new Intent(LADComplete.this, DashBoardActivity.class);
            //intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
        }
