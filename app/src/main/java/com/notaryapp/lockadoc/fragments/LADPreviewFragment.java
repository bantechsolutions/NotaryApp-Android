...
public class LADPreviewFragment extends Fragment {
  ...
  //  private String selfieUrl = AppUrl.API_BASE_URL+"uploadPhoto";
    ...
    public LADPreviewFragment() {
    }

    public LADPreviewFragment(String savedImage) {
    }

    public LADPreviewFragment(Uri imageUri, String savedImage) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        previewView = inflater.inflate(R.layout.lad_fragment_signerpersonal_peview, container, false);
        init();
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  CustomDialog.showProgressDialog(getActivity());
                ...
                loadFragment(new LADPartyProfileFragment(savedImage));
            }
        });
