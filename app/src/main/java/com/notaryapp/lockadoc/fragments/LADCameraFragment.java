...
import com.notaryapp.lockadoc.activityes.PhotographPartyActivity;
...
public class LADCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cameraFrontView = inflater.inflate(R.layout.lad_fragment_signerpersonal_camera, container, false);
        init();
    ...
    private void init() {
        ...
        ////
        btnSwitchCamera = cameraFrontView.findViewById(R.id.btnSwitchCamera);
    ...
    private void loadFragment(Fragment fragment) {
        FragmentViewUtil.replaceFragment(getActivity(), PhotographPartyActivity.REF_VIEW_CONTAINER, fragment, true);
    }
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == activity.RESULT_OK) {
                ...
                try {
                    ...
                    //Bitmap bitmap = handleSamplingAndRotationBitmap(getContext(), result.getUri());
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new LADPreviewFragment(result.getUri(), savedImage));
