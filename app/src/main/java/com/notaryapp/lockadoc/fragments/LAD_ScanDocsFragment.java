...
public class LAD_ScanDocsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.lad_fragment_scan_docs, container, false);
        init();
    ...
    class UpdateVACheck extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void voids) {
            ...
            ((ScanDocumentActivity)getActivity()).loadFragment(new LAD_AddDocDetailsFragment()) ;
        }
    }
