...
import com.notaryapp.ejournal.fragments.verifysigner.signerwitness.VEJ_Notarize_SignerWitnessSignerProfileFragment;
...
public class VEJ_VerifySignerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(userType != null){
            ...
            //Log.d("ID_W_TYPE", idType);
            loadFragment(new VEJ_Notarize_SignerWitnessSignerProfileFragment("pending", email, idType));
        }else {
