...
public class VEJ_EditProfileWitnessActivity extends BaseActivity {
       ...
       // buttonControls();
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                VEJ_EditProfileWitnessActivity.this.onBackPressed();
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data != null) {
            if (requestCode == PICK_IMAGE) {
                ...
                try {
                    bitmap = MediaStore.Images.Media.getBitmap(VEJ_EditProfileWitnessActivity.this.getContentResolver(), selectedImageUri);
...
//
    public Uri saveNewSelfie(String name, Bitmap myBitmap) {
        ...
        Uri imgUri = FileProvider.getUriForFile(VEJ_EditProfileWitnessActivity.this,
