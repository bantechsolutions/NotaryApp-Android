...
public class VEJ_MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(VEJ_MapActivity.this);
        ...
        btnFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //CustomDialog.showProgressDialog(VEJ_MapActivity.this);

                userLocation = new UserLocation();

                final LatLng currentMarkerLocation = mMap.getCameraPosition().target;

                Geocoder geocoder = new Geocoder(VEJ_MapActivity.this, Locale.getDefault());
                try {
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(VEJ_MapActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(VEJ_MapActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(VEJ_MapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION},
                    1000);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(VEJ_MapActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            SettingsClient settingsClient = LocationServices.getSettingsClient(VEJ_MapActivity.this);
            Task<LocationSettingsResponse> task = settingsClient.checkLocationSettings(builder.build());

            task.addOnSuccessListener(VEJ_MapActivity.this, new OnSuccessListener<LocationSettingsResponse>() {
                @Override
            ...
            task.addOnFailureListener(VEJ_MapActivity.this, new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    if (e instanceof ResolvableApiException) {
                        ResolvableApiException resolvable = (ResolvableApiException) e;
                        try {
                            resolvable.startResolutionForResult(VEJ_MapActivity.this, 51);
...
//                            Toast.makeText(MapActivity.this, "unable to get location", Toast.LENGTH_SHORT).show();
    ...
    class SaveLocation extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void v) {
            ...
            Intent locationIntent = new Intent(getApplicationContext(), VEJ_AddLocationActivity.class);
