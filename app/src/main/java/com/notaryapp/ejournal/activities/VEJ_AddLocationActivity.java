...
public class VEJ_AddLocationActivity extends BaseActivity {
    ...
    private void init() {
        ...
        databaseClient =  DatabaseClient.getInstance(VEJ_AddLocationActivity.this);
    ...
    private void buttonControls() {
        ...
        imgInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CustomDialog.notaryappInfoDialog(VEJ_AddLocationActivity.this,info.getVaAddLocation());
            }
        });
                ...
                try {
                    ...
                    if (data != null) {
                        if(data.has("success")){
                           ...
                           if(success.equals("1")) {
                               startActivity(new Intent(VEJ_AddLocationActivity.this, VEJ_NotarizeStepsActivity.class));
                               finish();
                           }
                            }else{
