...
public class VEJ_Notarize_AlertActivity extends AppCompatActivity {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  loadFragment(new Notarize_SignerWitnessCameraFragment());
                    ...
                    Intent intent = new Intent(VEJ_Notarize_AlertActivity.this, VEJ_NotarizeStepsActivity.class);
