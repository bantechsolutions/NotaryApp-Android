...
public class VEJ_VAComplete extends BaseActivity {
    ...
    private TextView head, contactDetail, contactDetail2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        head.setText("e-Journal™");
        contactDetail = findViewById(R.id.contactDetail);
        contactDetail.setText("e-JOURNAL™ Complete!");
        contactDetail2 = findViewById(R.id.contactDetail2);
        contactDetail2.setText("This completes the e-Journal™ process for this document.");
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VEJ_VAComplete.this, notaryappShareAppActivity.class);
...
//                                        phone = witness_obj.getString("phone");
        ...
        ivInfoAlert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CustomDialog.notaryappInfoDialogAlert(VEJ_VAComplete.this,getResources().getString(R.string.alert_test));
            }
        });
    }
