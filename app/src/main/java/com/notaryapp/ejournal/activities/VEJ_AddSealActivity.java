...
import com.notaryapp.ejournal.fragments.addseal.VEJ_Notarize_AddSealFragment;
...
public class VEJ_AddSealActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(update != null){
            loadFragment(new VEJ_Notarize_AddSealFragment(update));
        }
        else{

            loadFragment(new VEJ_Notarize_AddSealFragment());
        }
