...
public class VEJ_Notarize_VerifiFailedRetryFragment extends Fragment {

    // public static final int REF_VIEW_CONTAINER = R.id.identityRoot;
    private View retryView;
    private String docExpiryStatus;
    private String TAG = "VEJ_VerifiFailedRetryFragment";
    ...
    public VEJ_Notarize_VerifiFailedRetryFragment(String idStatus) {
        this.idStatus = idStatus;
    }

    public VEJ_Notarize_VerifiFailedRetryFragment
    ...
    class UpdateRetryCount extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer count) {
            ...
            if (count >= 1) {
                ...
                loadFragment(new VEJ_Notarize_SignerDocTypeFragment(selectedType));
            }
        }
    }
