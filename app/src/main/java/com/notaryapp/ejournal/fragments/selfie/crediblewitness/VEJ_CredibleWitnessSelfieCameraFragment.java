...
public class VEJ_CredibleWitnessSelfieCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public VEJ_CredibleWitnessSelfieCameraFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cameraFrontView = inflater.inflate(R.layout.fragment_credible_camera, container, false);
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new VEJ_CredibleWitnessSelfiePreviewFragment(result.getUri(), savedImage));
