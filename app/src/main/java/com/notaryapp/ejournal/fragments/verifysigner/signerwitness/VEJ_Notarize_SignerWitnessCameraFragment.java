...
public class VEJ_Notarize_SignerWitnessCameraFragment extends Fragment implements SurfaceHolder.Callback {
   ...
   Activity activity;
    ...
    public VEJ_Notarize_SignerWitnessCameraFragment() {
        // Required empty public constructor
    }

    public VEJ_Notarize_SignerWitnessCameraFragment(boolean back) {
        // Required empty public constructor
        this.back = back;
    }

    public VEJ_Notarize_SignerWitnessCameraFragment(String idType) {
        this.idType = idType;
    }
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                if (idType.equalsIgnoreCase("manually")){
                    loadFragment(new VEJ_Notarize_SignerWitnessPreviewFragment(result.getUri(), savedImage, "manually"));
                } else {
                    loadFragment(new VEJ_Notarize_SignerWitnessPreviewFragment(result.getUri(), savedImage));
                }
