...
public class VEJ_Notarize_SignerWitnessPreviewFragment extends Fragment {
   ...
   // private DatabaseClient databaseClient;
    ...
    private VEJ_Notarize_SignerWitnessCameraFragment vej_notarize_signerWitnessCameraFragment;

    public VEJ_Notarize_SignerWitnessPreviewFragment() {
    }

    public VEJ_Notarize_SignerWitnessPreviewFragment(Uri imageUri, String savedImage) {
        this.imageUri = imageUri;
        this.savedImage = savedImage;
    }

    public VEJ_Notarize_SignerWitnessPreviewFragment(Uri imageUri, String savedImage, String idType) {
        this.imageUri = imageUri;
        this.savedImage = savedImage;
        this.idType = idType;
    }
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (idType.equalsIgnoreCase("manually")){
                    loadFragment(new VEJ_Notarize_SignerWitnessSignerProfileFragment(savedImage,imageUri, null, "manually"));
                } else {
                    loadFragment(new VEJ_Notarize_SignerWitnessSignerProfileFragment(savedImage,imageUri, null, "null"));
                }
    ...
    private void init(){
        ...
        //bitmap = vej_notarize_signerWitnessCameraFragment.getCroppedBitmap();
