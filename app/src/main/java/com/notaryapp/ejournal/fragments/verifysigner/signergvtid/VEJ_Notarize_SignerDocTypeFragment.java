...
public class VEJ_Notarize_SignerDocTypeFragment extends Fragment implements NetverifyDeallocationCallback {

    private static final int REF_VIEW_CONTAINER = R.id.verifySignerContainer;
    private String TAG = "VEJ_SignerDocType";
    ...
    public VEJ_Notarize_SignerDocTypeFragment() {
        // Required empty public constructor
    }

    public VEJ_Notarize_SignerDocTypeFragment(String selectedType) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Testing
              /*loadFragment(new VEJ_Notarize_ProcessFragment("Driving license", "49c72272-8343-4a00-8acb-3f858ccc3cfa"));*/
                //Testing

                if(transactionCount>0 && (!(daysLeft > 0))){
                    /*loadFragment(new VEJ_Notarize_ProcessFragment("Identity Card", "c6bd4470-5fd9-458b-9e80-958bafd15bbc"));*/
        ...
        if (requestCode == NetverifySDK.REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
              ...
              //  new InsertJumioScanDetails().execute();
                ...
                loadFragment(new VEJ_Notarize_ProcessFragment(selectedType,scanReference));
                //lahar
