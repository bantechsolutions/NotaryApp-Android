package com.notaryapp.ejournal.fragments.verifysigner.personallyknown;
...
public class VEJ_Notarize_SignerPersonalPreviewFragment extends Fragment {
  ...
  //  private String selfieUrl = AppUrl.API_BASE_URL+"uploadPhoto";
    ...
    public VEJ_Notarize_SignerPersonalPreviewFragment() {
    }

    public VEJ_Notarize_SignerPersonalPreviewFragment(String savedImage) {
    }

    public VEJ_Notarize_SignerPersonalPreviewFragment(Uri imageUri, String savedImage) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  CustomDialog.showProgressDialog(getActivity());
                ...
                loadFragment(new VEJ_Notarize_SignerPersonalProfileFragment(savedImage));
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new VEJ_Notarize_SignerPersonalCameraFragment());
            }
        });
