...
public class VEJ_SignatureCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public VEJ_SignatureCameraFragment() {
        // Required empty public constructor
    }
    public VEJ_SignatureCameraFragment(String signerEmail, String signerFirstName) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cameraFrontView = inflater.inflate(R.layout.vej_fragment_thumbprint_camera, container, false);
        init();
    ...
    private void init() {
        ...
        noteTxt=cameraFrontView.findViewById(R.id.note);
        skipTxt = cameraFrontView.findViewById(R.id.skipTxt);

        skipTxt.setVisibility(View.GONE);
        mainHead.setText("Take a Picture of Signer's Signature");

        noteTxt.setText("Take Photo of Signature");
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new VEJ_SignaturePreviewFragment(result.getUri(), savedImage, signerEmail, signerFirstName));
                //loadFragment(new Notarize_SignerPersonalPreviewFragment(result.getUri(), savedImage));
                /*Intent intent = new Intent(getActivity(), SignAndThumbCameraPreviewActivity.class);
                intent.putExtra("imgUri",result.getUri().toString());
