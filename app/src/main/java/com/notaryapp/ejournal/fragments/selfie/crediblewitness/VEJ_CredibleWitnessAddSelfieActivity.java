...
public class VEJ_CredibleWitnessAddSelfieActivity extends BaseActivity {
    ...
    String firstName ="",lastName = "", scanRef = "",pending = "", signerEmail="", idType="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signerEmail = getIntent().getStringExtra("SignerEmail");
