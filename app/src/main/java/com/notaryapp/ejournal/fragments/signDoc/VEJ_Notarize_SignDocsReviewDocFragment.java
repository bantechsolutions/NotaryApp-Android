...
public class VEJ_Notarize_SignDocsReviewDocFragment extends Fragment {
    ...
    public VEJ_Notarize_SignDocsReviewDocFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_notarize_sign_docs_review_doc, container, false);
        init();
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBox1.isChecked() && checkBox2.isChecked()){
                    ...
                    loadFragment(new VEJ_Notarize_SignDocs_Sign_DocumentsFragment());
                } else {
