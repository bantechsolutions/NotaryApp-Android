...
public class VEJ_Notarize_SignerPersonalCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public VEJ_Notarize_SignerPersonalCameraFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cameraFrontView = inflater.inflate(R.layout.fragment_notarize_signerpersonal_camera, container, false);
        init();
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new VEJ_Notarize_SignerPersonalPreviewFragment(result.getUri(), savedImage));
