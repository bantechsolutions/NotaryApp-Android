...
public class VEJ_ThumbprintCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public VEJ_ThumbprintCameraFragment() {
        // Required empty public constructor
    }
    public VEJ_ThumbprintCameraFragment(String signerEmail) {
    ...
    private void init() {
        ...
        skip = cameraFrontView.findViewById(R.id.skipTxt);
        ...
        mainHead.setText("Please take a photo of the signer’s right thumbprint on a piece of plain white paper.");
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new VEJ_ThumbprintPreviewFragment(result.getUri(), savedImage, signerEmail));
