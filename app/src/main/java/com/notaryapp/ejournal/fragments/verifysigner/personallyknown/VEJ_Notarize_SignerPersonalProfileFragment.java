...
public class VEJ_Notarize_SignerPersonalProfileFragment extends Fragment {
    ...
    private final String TAG = "VEJ_EditSignerFragment";
    private View view;
    ...
    public VEJ_Notarize_SignerPersonalProfileFragment(String signerImg) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_notarize_edit_signer_personal, container, false);
        init();
