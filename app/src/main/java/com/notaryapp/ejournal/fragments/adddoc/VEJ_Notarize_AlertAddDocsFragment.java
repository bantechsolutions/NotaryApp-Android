...
public class VEJ_Notarize_AlertAddDocsFragment extends Fragment {
    ...
    public VEJ_Notarize_AlertAddDocsFragment(String docName, String serverDocName) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        docAlertView = inflater.inflate(R.layout.vej_fragment_notarize_alert_add_docs, container, false);
        init();
