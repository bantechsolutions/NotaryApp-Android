...
import com.notaryapp.ejournal.fragments.addseal.VEJ_Notarize_SealCodeFragment;
...
public class VEJ_VAStampListAdapter extends PagerAdapter {
    ...
    public VEJ_VAStampListAdapter(Context context, String update, ArrayList<AddStamp> listStamps, int adapterType) {
       ...
       /*     btnCaptureStamp.setOnClickListener(new View.OnClickListener() {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Fragment fragment;
                    fragment = new VEJ_Notarize_SealCodeFragment(selectdLicense,update,addSelectedStamp.getStampImgPath());
                    activity.getSupportFragmentManager().beginTransaction()
                            .replace(AddSealActivity.REF_VIEW_CONTAINER, fragment).addToBackStack(null).commit();
