...
public class VEJ_VAStepsAdapter extends RecyclerView.Adapter<VEJ_VAStepsAdapter.MyView>{
    ...
    private VEJ_NotarizeStepsActivity vej_notarizeStepsActivity ;
    ...
    public VEJ_VAStepsAdapter(List<SignerReg> horizontalList, Context context) {
        this.list = horizontalList;
        this.context = context;
        //new GetWitnessCount().execute();
        new GetWitness().execute();
        this.vej_notarizeStepsActivity = (VEJ_NotarizeStepsActivity)context;
    }

    @Override
    public MyView onCreateViewHolder(ViewGroup parent, int viewType) {

        //vej_notarizeStepsActivity = new VEJ_NotarizeStepsActivity();
...
//                                .into(holder.itemImage);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0) {
                    /*if(vej_notarizeStepsActivity.isClick) {
                        Intent intent = new Intent(activity, VEJ_VerifySignerActivity.class);
                        activity.startActivity(intent);
                    }else{
                        //Utils.toastCenter(vej_notarizeStepsActivity,vej_notarizeStepsActivity.getResources().getString(R.string.click_message));
                    }*/
                    if(vej_notarizeStepsActivity.getIsClick()) {
                        Intent intent = new Intent(activity, VEJ_VerifySignerActivity.class);
                        activity.startActivity(intent);
                    }else{
                        //Utils.toastCenter(vej_notarizeStepsActivity,vej_notarizeStepsActivity.getResources().getString(R.string.click_message));
