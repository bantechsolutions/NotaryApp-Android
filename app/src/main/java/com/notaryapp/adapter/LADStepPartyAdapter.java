...
public class LADStepPartyAdapter extends RecyclerView.Adapter<LADStepPartyAdapter.MyView>{
    ...
    public LADStepPartyAdapter(List<LADParties> horizontalList,
                               int stampCountArray,
                               Context context) {
    ...
    public void onBindViewHolder(final MyView holder, final int position) {
        ...
        if (position==0){
            holder.setItemTitle("Add Photograph");
        ...
        holder.docImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0) {
                    ...
                    Intent intent = new Intent(activity, PhotographPartyActivity.class);
