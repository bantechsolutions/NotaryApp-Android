...
public class VAStepDocsAdapter extends RecyclerView.Adapter<VAStepDocsAdapter.MyView>{
    ...
    public VAStepDocsAdapter(List<DocumentsModel> horizontalList, List<Integer> stampCountArray, Context context) {
...
//                            .into(holder.docImage);
        ...
        holder.docImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0) {
                    Intent intent = new Intent(activity, AddDocsActivity.class);
