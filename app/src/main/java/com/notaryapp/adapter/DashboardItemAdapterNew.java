...
public class DashboardItemAdapterNew extends RecyclerView.Adapter<DashboardItemAdapterNew.MyView> implements Filterable {
    ...
    //    public DashboardItemAdapter(List<AllTransactions> horizontalList){
//        this.list = horizontalList;
//        mFilteredList = horizontalList;
//    }
    public DashboardItemAdapterNew(LoadingCompletedInterface loadingCompletedInterface,
    ...
    private class LoadingViewHolder extends DashboardItemAdapterNew.MyView{
    ...
    public void onBindViewHolder(final MyView holder, @SuppressLint("RecyclerView") final int position) {
        if (holder instanceof MyView){
            try {
                ...
                } else if (dashItem.getTranType().equalsIgnoreCase("VEJ")) {
                ...
                if (dashItem.getTranType().equalsIgnoreCase("VID")) {
                    ...
                    if (dashItem.getSigner() != null
                        ...
                        //holder.imgPro.setImageResource(R.drawable.ic_document);
                        //holder.homeprogress.setVisibility(View.GONE);
                        Utils.loadImageDashboardVEJ((Activity) context,
                                "",
                                holder.imgPro,
                                holder.homeprogress);
                        //}
...
//                }
    ...
    private void showLoadingView(LoadingViewHolder MyView, int position){
                ...
                try {
                    ...
                    if (data != null) {
                        if (type.equals("star")) {
                            ...
                            String fName, lName, email, phone, scanRef, rowId, signerEmail, docType,
                                    docName = "", apnNum, serverDocName, profileImgPath, witProImgPath = "", signatureImgPath, thumprintImgPath;
...
//                            //Log.e("Notarise", level);
                            ...
                            if (tranType.equalsIgnoreCase("LAD")) {
                                ...
                                Intent intent = new Intent(context, VEJ_NotarizeStepsActivity.class);
                                intent.putExtra("From", "Pending");
                                context.startActivity(intent);
                                ((Activity) context).finish();
