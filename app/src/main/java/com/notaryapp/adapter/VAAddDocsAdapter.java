...
public class VAAddDocsAdapter extends RecyclerView.Adapter<VAAddDocsAdapter.MyView>{
    ...
    public VAAddDocsAdapter(List<DocumentsModel> horizontalList, String transactionId, Context context, Activity activity) {
