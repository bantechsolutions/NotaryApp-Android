...
public class ShareSignersAdapter extends RecyclerView.Adapter<ShareSignersAdapter.MyView>{
    ...
    public ShareSignersAdapter(List<SignerReg> horizontalList, ShareListerner shareInterface, List<Boolean> isSelected,Context context) {
