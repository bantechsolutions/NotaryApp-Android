...
public class VACompleteAdapter extends RecyclerView.Adapter<VACompleteAdapter.MyView>{
    ...
    public VACompleteAdapter(List<SignerReg> horizontalList, Context context) {
    ...
    public void onBindViewHolder(final MyView holder, final int position) {
            ...
            if(stepsModel.getSignerType().equals("PER")){

                holder.imageVerified.setImageDrawable(context.getDrawable(R.drawable.notary_verified));
            }
            else if(stepsModel.getSignerType().equals("WIT")){

                holder.imageVerified.setImageDrawable(context.getDrawable(R.drawable.witness_verified));
            }
            else{

                holder.imageVerified.setImageDrawable(context.getDrawable(R.drawable.notaryapp_verified));
            }
