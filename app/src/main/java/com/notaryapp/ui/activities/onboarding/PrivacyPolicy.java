...
public class PrivacyPolicy extends BaseActivity {
    ...
    private void getDocTypes() {
        ...
        try {
            ...
            getApiRequest.request(this, iJsonListener, AppUrl.GET_PRIVACY_POLICY, "GET_PRIVACY_POLICY");
    ...
    private void loadDatatoHtml() {
        ...
        float fontSize = res.getDimension(R.dimen.extraSmallText);
        web_view.getSettings().setDefaultFontSize((int) fontSize);*/
