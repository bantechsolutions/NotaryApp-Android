...
import com.notaryapp.ui.fragments.verifyauthenticate.adddoc.Notarize_AddDocFragmentLanding;
import com.notaryapp.ui.fragments.verifyauthenticate.adddoc.Notarize_AddDocsFragment;
...
public class AddDocsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(docName != null && serverDocName != null){
            ...
            loadFragment(new Notarize_AddDocsFragment());
        }
...
//        demoFragment.onActivityResult(requestCode, resultCode, data);
        ...
        Notarize_AddDocFragmentLanding demoFragment = (Notarize_AddDocFragmentLanding)
                getSupportFragmentManager().findFragmentById(REF_VIEW_CONTAINER);
        demoFragment.onActivityResult(requestCode, resultCode, data);
    }
