...
public class GovIssuedIdSelfieCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public GovIssuedIdSelfieCameraFragment() {
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new GovIssuedIdSelfiePreviewFragment(result.getUri(), savedImage));
