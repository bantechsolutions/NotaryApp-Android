...
public class AddLocationActivity extends BaseActivity {
    ...
    private void init() {
        ...
        databaseClient =  DatabaseClient.getInstance(AddLocationActivity.this);
    ...
    private void buttonControls() {
        ...
        imgInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CustomDialog.notaryappInfoDialog(AddLocationActivity.this,info.getVaAddLocation());
            }
        });
                ...
                try {
                    ...
                    if (data != null) {
                        if(data.has("success")){
                           ...
                           if(success.equals("1")) {
                               startActivity(new Intent(AddLocationActivity.this, NotarizeStepsActivity.class));
                               finish();
                           }
                            }else{
