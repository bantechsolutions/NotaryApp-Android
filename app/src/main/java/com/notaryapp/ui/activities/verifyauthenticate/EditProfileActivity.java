    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layOutWitnessOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EditProfileActivity.this,EditProfileWitnessActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data != null) {
            if (requestCode == PICK_IMAGE) {
                ...
                try {
                    bitmap = MediaStore.Images.Media.getBitmap(EditProfileActivity.this.getContentResolver(), selectedImageUri);
...
//            Log.e("SAVE_IMAGE", e.getMessage(), e);
        ...
        Uri imgUri = FileProvider.getUriForFile(EditProfileActivity.this,
