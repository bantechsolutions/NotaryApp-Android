...
public class TSRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TSRecyclerViewAdapter(List<ReportItems> horizontalList, Context mContext){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ts_report, parent, false);
    ...
    private void populateItemRows(final ItemViewHolder viewHolder, final int position) {
        ...
        viewHolder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("ReportStatus", "Active");
