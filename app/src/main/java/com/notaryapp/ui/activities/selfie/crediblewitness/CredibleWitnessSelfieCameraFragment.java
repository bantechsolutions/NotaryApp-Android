...
public class CredibleWitnessSelfieCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public CredibleWitnessSelfieCameraFragment() {
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new CredibleWitnessSelfiePreviewFragment(result.getUri(), savedImage));
