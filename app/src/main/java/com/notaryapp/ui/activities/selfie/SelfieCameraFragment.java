...
public class SelfieCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cameraFrontView = inflater.inflate(R.layout.fragment_onbording_camera, container, false);
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                loadFragment(new SelfiePreviewFragment(result.getUri(), savedImage));
