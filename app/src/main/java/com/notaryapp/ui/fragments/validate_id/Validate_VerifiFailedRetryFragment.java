...
public class Validate_VerifiFailedRetryFragment extends Fragment {
    ...
    private int balanceTransCount,retryCount,selectIdCount;
    private Context context;
    private IJsonListener iJsonListener;
    private ValidateId_IdentityType identityType;

    public Validate_VerifiFailedRetryFragment
    ...
    private void loadFragment(Fragment fragment) {
        FragmentViewUtil.replaceFragment(getActivity(),
                ValidateActivity.REF_VIEW_CONTAINER,
                fragment, false);
    ...
    class UpdateRetryCount extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... voids) {
            ...
            selectedType =  databaseClient.getAppDatabase().validateIdIdentityTypeDao().getSelectedType();
            retryCount = databaseClient.getAppDatabase().validateIdIdentityTypeDao().getRetryCount(selectedType);
           databaseClient.getAppDatabase().validateIdIdentityTypeDao().updateRetryCount(selectedType);
           // selectIdCount =  databaseClient.getAppDatabase().validateIdIdentityTypeDao().deletedCount();
            return 0;
        }
        ...
        protected void onPostExecute(Integer count) {
            ...
            if(retryCount >= 1){
                ...
                loadFragment(new Validate_SelectIdFragment(selectedType));
            }
                            ...
                            if (type.equals("Transactions")) {
                                ...
                                balanceTransCount = total_bought - total_used;
                                    ...
                                    if(balanceTransCount>0){
                                       ...
                                       proceedDialog("Transaction successfull . But Your plan expired , please recharge before next transaction. ");
                                    }else{
