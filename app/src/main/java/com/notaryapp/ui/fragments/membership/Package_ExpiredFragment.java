...
public class Package_ExpiredFragment extends Fragment {

    private View expireView;
    private TextView txtMoreDeatils;
    private Button closeBtn,upgradeBtn;
    private String from;
    public Package_ExpiredFragment() {
        // Required empty public constructor
    }
    public Package_ExpiredFragment(String from) {
      this.from = from;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expireView = inflater.inflate(R.layout.activity_package_expired, container, false);
        init();
