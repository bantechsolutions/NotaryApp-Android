package com.notaryapp.ui.fragments.verifyauthenticate.addseal;
...
import com.notaryapp.adapter.VAStampListAdapter;
...
public class Notarize_AddSealFragment extends Fragment {
    ...
    public Notarize_AddSealFragment() {
        // Required empty public constructor
    }

    public Notarize_AddSealFragment(String update) {
    ...
    private void setupViewPager() {
        ...
        VAStampListAdapter adapter = new VAStampListAdapter(getActivity(),update, stampList, ADAPTER_TYPE_TOP);
