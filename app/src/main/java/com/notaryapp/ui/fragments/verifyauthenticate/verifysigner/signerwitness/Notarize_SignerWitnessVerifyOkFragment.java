...
public class Notarize_SignerWitnessVerifyOkFragment extends Fragment {
    ...
    public Notarize_SignerWitnessVerifyOkFragment(String firstName, String lastName, String scanRef, int pending){
        this.firstName = firstName;
        this.lastName = lastName;
        this.scanRef = scanRef;
        this.pending = pending;
    }
    public Notarize_SignerWitnessVerifyOkFragment(String firstName,String lastName,String scanRef, int pending, String signerEmail){
        this.firstName = firstName;
        this.lastName = lastName;
        this.scanRef = scanRef;
        this.pending = pending;
    ...
    public Notarize_SignerWitnessVerifyOkFragment(String firstName, String lastName, String scanRef, String signerEmail){
        this.firstName = firstName;
        this.lastName = lastName;
        this.scanRef = scanRef;
        this.signerEmail = signerEmail;
    }
    /*public Notarize_SignerWitnessVerifyOkFragment(String docStatus, String trsnsStatus, String veriStatus, String docExpiryStatus){
