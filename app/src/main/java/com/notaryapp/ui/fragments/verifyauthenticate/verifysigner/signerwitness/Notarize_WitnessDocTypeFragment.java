...
public class Notarize_WitnessDocTypeFragment extends Fragment implements NetverifyDeallocationCallback {
  ...
  //  private CustomDocumentAdapter customDocumentAdapter;
    ...
    public Notarize_WitnessDocTypeFragment() {
        // Required empty public constructor
    }
    public Notarize_WitnessDocTypeFragment(String selectedType) {
        this.selectedType = selectedType;
    }
    public Notarize_WitnessDocTypeFragment(String selectedType, String signerEmail) {
        this.selectedType = selectedType;
        this.signerEmail = signerEmail;
    }
    public Notarize_WitnessDocTypeFragment(int pending) {
        this.pending = pending;
    }
    public Notarize_WitnessDocTypeFragment(int pending, String signerEmail) {
        this.pending = pending;
        this.signerEmail = signerEmail;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (transactionCount>0 && (!(daysLeft > 0))) {
                    ...
                    /*if(pending == 1){
                        loadFragment(new Notarize_SignerWitnessProcessFragment("Identity Card", "c6bd4470-5fd9-458b-9e80-958bafd15bbc",1, signerEmail));
                    }else {
                        loadFragment(new Notarize_SignerWitnessProcessFragment("Identity Card", "c6bd4470-5fd9-458b-9e80-958bafd15bbc",1, signerEmail));
                    }*/
                }else{
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new Notarize_SignerWitnessSignerProfileFragment("pending", signerEmail));
            }
        });
        ...
        if (requestCode == NetverifySDK.REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
              ...
              //  new InsertJumioScanDetails().execute();
                /*if(pending == 1){
                    loadFragment(new Notarize_SignerWitnessProcessFragment(selectedType, scanReference,1));
                }else {
                    loadFragment(new Notarize_SignerWitnessProcessFragment(selectedType, scanReference));
                }*/
                /*if(pending == 1){
                    loadFragment(new Notarize_SignerWitnessProcessFragment(selectedType, scanReference,1, signerEmail));
                }else {
                    loadFragment(new Notarize_SignerWitnessProcessFragment(selectedType, scanReference,1, signerEmail));
                }*/
                loadFragment(new Notarize_SignerWitnessProcessFragment(selectedType, scanReference,1, signerEmail));
