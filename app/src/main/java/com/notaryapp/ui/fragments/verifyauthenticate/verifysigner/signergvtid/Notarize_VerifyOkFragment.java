...
public class Notarize_VerifyOkFragment extends Fragment {
    ...
    public Notarize_VerifyOkFragment(){

    }
    public Notarize_VerifyOkFragment(String firstName,String lastName,String scanRef){
        this.firstName = firstName;
        this.lastName = lastName;
        this.scanRef = scanRef;
    }
    public Notarize_VerifyOkFragment(String docStatus, String trsnsStatus, String veriStatus, String docExpiryStatus){
