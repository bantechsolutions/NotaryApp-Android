...
public class AllowAccessFragment extends Fragment {
    ...
    public AllowAccessFragment(String checkReg) {
        this.checkReg = checkReg;
    }
    public AllowAccessFragment() {
    ...
    protected void checkPermission(){
        if(ContextCompat.checkSelfPermission(mActivity, Manifest.permission.CAMERA)
            ...
            /*if(checkReg.equals("1016")){
                // FragmentViewUtil.removeFragment(getActivity(),currentFragment);
