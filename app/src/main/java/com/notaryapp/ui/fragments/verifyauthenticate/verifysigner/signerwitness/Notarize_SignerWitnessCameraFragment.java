...
public class Notarize_SignerWitnessCameraFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private String selectedTypeRoom, savedImage, idType="";
   ...
   Activity activity;
    ...
    public Notarize_SignerWitnessCameraFragment() {
        // Required empty public constructor
    }

    public Notarize_SignerWitnessCameraFragment(boolean back) {
        // Required empty public constructor
        this.back = back;
    }

    public Notarize_SignerWitnessCameraFragment(String idType) {this.idType = idType;}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        cameraFrontView = inflater.inflate(R.layout.fragment_notarize_signercrediblewitness_camera, container, false);
        init();
...
//            @Override
//            public void onClick(View v) {
//                loadFragment(new Validate_PreviewFragment()) ;
//            }
//        });
...
//                    Log.e("SAVE_IMAGE", e.getMessage(), e);
                ...
                if (idType.equalsIgnoreCase("manually")){
                    loadFragment(new Notarize_SignerWitnessPreviewFragment(result.getUri(), savedImage, "manually"));
                } else {
                    loadFragment(new Notarize_SignerWitnessPreviewFragment(result.getUri(), savedImage));
                }
