package com.notaryapp.ui.fragments.verifyauthenticate.verifysigner;
...
import com.notaryapp.ui.activities.selfie.govissuedid.GovIssuedIdAddSelfieActivity;
import com.notaryapp.ui.activities.verifyauthenticate.VerifySignerActivity;
import com.notaryapp.ui.fragments.verifyauthenticate.verifysigner.personallyknown.Notarize_SignerPersonalAlertFragment;
import com.notaryapp.ui.fragments.verifyauthenticate.verifysigner.signergvtid.Notarize_SignerDocTypeFragment;
import com.notaryapp.ui.fragments.verifyauthenticate.verifysigner.signerwitness.Notarize_SignerWitnessAlertFragment;
import com.notaryapp.utils.FragmentViewUtil;


public class Notarize_SignerVerifyTypeFragment extends Fragment {
  ...
  //  private static final int REF_VIEW_CONTAINER = R.id.verifySignerContainer;
    ...
    public Notarize_SignerVerifyTypeFragment() {
    ...
    private void buttonControls() {
        ...
        government_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), GovIssuedIdAddSelfieActivity.class);
        ...
        witness.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new Notarize_SignerWitnessAlertFragment());
                //Testing
        ...
        witness_m.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new Notarize_SignerWitnessAlertFragment("manually"));
            }
        });
    }
