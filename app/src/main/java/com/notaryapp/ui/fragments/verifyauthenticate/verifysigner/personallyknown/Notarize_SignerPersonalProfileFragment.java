...
public class Notarize_SignerPersonalProfileFragment extends Fragment {
    ...
    public Notarize_SignerPersonalProfileFragment(String signerImg) {
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* if (!Validation.hasValue(stateNameEdt,stateText)) {
                ...
                if (validFName && validLName && validEmail && validPhone && validCEmail && validAddress1 && validCity && validState && validZip) {
                    try {
