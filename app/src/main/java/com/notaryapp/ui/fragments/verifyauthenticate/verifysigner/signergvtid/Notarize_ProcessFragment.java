...
public class Notarize_ProcessFragment extends Fragment {
    ...
    private boolean Notarize_VerifyOkFragment = false;

    private boolean wasRunning;

    public Notarize_ProcessFragment(String selectedType,String scanRef) {
        this.selectedType = selectedType;
        this.scanRef = scanRef;
    }
    public Notarize_ProcessFragment() {
...
//                            getJumioResponse();
                            ...
                            runningNegative = false;
                            loadFragment(new Notarize_VerifiFailedRetryFragment(null, null, null, null, ""),"");
                            return;
                        }
                    }
                    if(runningNegative){
...
//        btnClose = processView.findViewById(R.id.btn_pro_close);
    ...
    private void loadFragment(Fragment fragment, String TAG) {
        ...
        if(TAG.equals("Notarize_VerifyOkFragment")){
            if(Notarize_VerifyOkFragment) {
                Notarize_VerifyOkFragment = false;
                if (getActivity() != null) {
        ...
        iJsonListener = new IJsonListener() {
                        ...
                        if (type.equals("Jumio")) {
                            ...
                            try {
                                ...
                                if(documentStatus.equals("APPROVED_VERIFIED")) {
                                    ...
                                    {
                                        Notarize_VerifyOkFragment = true;
                                        loadFragment(new Notarize_VerifyOkFragment(firstName, lastName, scanRef),"Notarize_VerifyOkFragment");
                                        ...
                                        loadFragment(new Notarize_VerifiFailedRetryFragment(documentStatus, transactionStatus, verificationStatus, docExpiryStatus, retry),"");
                                        //   getActivity().onBackPressed();
                                    }

                                }else{
                                    loadFragment(new Notarize_VerifiFailedRetryFragment(documentStatus, transactionStatus, verificationStatus, docExpiryStatus, "YES"),"");
                                }
                                // }
                            } catch (Exception e) {
                                //e.printStackTrace();
            ...
            public void onFetchFailure(String msg) {
                ...
                if(waitTimeExpired && !runningPositive && !runningNegative) {
                    ...
                    loadFragment(new Notarize_VerifiFailedRetryFragment(documentStatus, transactionStatus,
