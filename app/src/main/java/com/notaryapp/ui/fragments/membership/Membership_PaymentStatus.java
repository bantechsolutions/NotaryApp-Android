...
public class Membership_PaymentStatus extends Fragment {

    private View expireView;
    private TextView txtMoreDeatils;
    private Button closeBtn,upgradeBtn;
    private String from;
    public Membership_PaymentStatus() {
        // Required empty public constructor
    }
    public Membership_PaymentStatus(String from) {
      this.from = from;
    }
    @Override
...
//        });
    ...
    private void init(){
        closeBtn = expireView.findViewById(R.id.btn_pro_close4);
