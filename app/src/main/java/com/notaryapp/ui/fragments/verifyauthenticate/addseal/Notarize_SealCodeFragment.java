...
public class Notarize_SealCodeFragment extends Fragment {
    ...
    public Notarize_SealCodeFragment(String licenseNo,String selectedStamp) {
        this.licenseNo = licenseNo;
        this.selectedStamp = selectedStamp;
    }

    public Notarize_SealCodeFragment(String licenseNo,String update,String selectedStamp) {
        this.licenseNo = licenseNo;
        this.selectedStamp = selectedStamp;
        this.update = update;
    }
