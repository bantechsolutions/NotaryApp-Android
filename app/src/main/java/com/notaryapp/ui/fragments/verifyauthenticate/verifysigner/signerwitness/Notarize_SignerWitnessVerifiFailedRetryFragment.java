...
public class Notarize_SignerWitnessVerifiFailedRetryFragment extends Fragment {
   ...
   /* public Notarize_SignerWitnessVerifiFailedRetryFragment(String idStatus) {
    ...
    public Notarize_SignerWitnessVerifiFailedRetryFragment
    ...
    class UpdateRetryCount extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer count) {
            ...
            if (count >= 1) {
                ...
                loadFragment(new Notarize_WitnessDocTypeFragment(selectedType, signerEmail));
            }
        }
    }
